...
function [A,x_0,y_0,sigma_x,sigma_y,a,b,c] = airyFit(image,massimo,minimo,centro_x,centro_y,var_x,var_y,stat)
...
%         end
    ...
    %stampo errore ->modello statistico
...
%     end
    ...
    title(['square residuals, SSerr is: ',num2str(SSerr)]);
