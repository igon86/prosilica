...
function [A,x_0,y_0,sigma_x,sigma_y,a,b,c,B,s_x,s_y] = gaussianPotatoFit(image,max,min,centro_x,centro_y,var_x,var_y)
    ...
    for i=1:m
        ...
        y = floor(i/dimx);
        z = img(i);
        immagine(i) = valutaPuntoPotato(A,x_0,y_0,sigma_x,sigma_y,a,b,c,B,s_x,s_y,x,y);
    end
