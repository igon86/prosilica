...
do
	...
	#COMPILO
	echo "mpicc $FLAGS -Wall -pedantic  -I/opt/local/var/macports/software/gsl/1.12_0/opt/local/include -lgsl -lgslcblas -lm -ltiff ./farm.c ./fit.c ./image
.c ./macro.c -L/opt/local/var/macports/software/gsl/1.12_0/opt/local/lib -o farm" >> test.sh
