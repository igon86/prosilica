...
class GTK_Main:
    def __init__(self):
        ...
        pngdec0 = gst.element_factory_make("pngdec","pngdec0")
        ...
        self.player.add(udpsrc, pngdec0,colorspace,imgsink)
        gst.element_link_many(udpsrc, pngdec0,colorspace,imgsink)
