...
newlive:
	$(CC) $(RPATH) $(TARGET) -I/opt/local/var/macports/software/gsl/1.12_0/opt/local/include/ $(CFLAGS) $(LTIFF) $(MAT) streamCpy.cpp modfit.cpp mysnap.cpp psnap.cpp tiffPostElaboration.cpp -o live $(LIB) -lgsl -lgslcblas -L/opt/local/var/macports/software/gsl/1.12_0/opt/local/lib
