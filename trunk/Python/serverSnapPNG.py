...
class GTK_Main:
    ...
    def __init__(self):
        ...
        colorspace0 = gst.element_factory_make("ffmpegcolorspace","colorspace0")
        ...
        pngenc0 = gst.element_factory_make("pngenc","pngenc0")
        ...
        self.player.add(self.source,colorspace0,queue,self.text,colorspace1,pngenc0,udpsnk)
        gst.element_link_many(self.source,colorspace0,queue,self.text,colorspace1,pngenc0,udpsnk)
